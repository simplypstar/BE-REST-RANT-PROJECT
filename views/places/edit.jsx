                ...
                <form method="POST" action={`/places/${data.place.id}?_method=PUT`}>
                    <div className="row">
                        ...
                        <div className="form-group col-sm-6">
                            ...
                            <input className="form-control" type="text" id="pic" name="pic" defaultValue={data.place.pic}/>
                        </div>
                    </div>
                    <div className="row">
                        <div className="form-group col-sm-6">
                        ...
                        <div className="form-group col-sm-6">
                            ...
                            <select className="form-control" id="state" name="state" size="1" defaultValue={data.place.state}>
